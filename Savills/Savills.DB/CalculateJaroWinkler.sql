...
select dbo.fn_calculateJaroWinkler('As you can see above the result of the score for comparing','As you can see above the result of the score for comparing')
select dbo.fn_calculateJaroWinkler('Peter','Pit')
select dbo.fn_calculateJaro('Peter','Pit')
